...
import { EventWebSockets, WS_EVENTS_PATH } from './server/EventWebSockets.ts'
import {authorizedRequest} from './server/authorizedRequest.js'
...
const routes: ServeFunctionOptions<any, any>['routes'] = {
    ...
    '/lib/sidelines/eventStream.js': lib(eventStreamWorker),
