...
export const QViewerReposActivityData: string =
    'query QViewerReposActivityData($pageSize: Int!, $cursor: String) { viewer { repositories(affiliations: [OWNER], first: $pageSize, after: $cursor) { nodes { ... on Repository { name stargazerCount updatedAt } } pageInfo { endCursor hasNextPage } } } }'
